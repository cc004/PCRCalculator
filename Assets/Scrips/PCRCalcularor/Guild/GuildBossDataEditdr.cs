...
namespace PCRCaculator.Guild
{
    ...
    public class GuildBossDataEditdr : MonoBehaviour
    {
        ...
        public void SetData(int enemyId)
        {
            ...
            inputField_def_mg.text = "" + enemyData.baseData.Magic_def;
            inputField_atk.text = "" + enemyData.baseData.Atk;
            inputField_atk_mg.text = "" + enemyData.baseData.Magic_str;
            inputField_cri.text = "" + enemyData.baseData.Physical_critical;
            inputField_cri_mg.text = "" + enemyData.baseData.Magic_critical;
            inputField_dodge.text = "" + enemyData.baseData.Dodge;
            inputField_acc.text = "" + enemyData.baseData.Accuracy;
            inputField_tp_up.text = "" + enemyData.baseData.Energy_recovery_rate;
            inputField_tp_reduce.text = "" + enemyData.baseData.Enerey_reduce_rate;
