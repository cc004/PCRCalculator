        ...
        public static ActionParameter GetActionParameterByActionType(eActionType actionType,out bool isSuccess)
        {
            ...
            switch (actionType)
            {
                ...
                case eActionType.DAMAGE_CHARGE:
                    ...
                    break;
                case eActionType.DECOY:
                    action = new DecoyAction();
                    break;
                ...
                case eActionType.IF_FOR_AL:
                    ...
                    break;
                case eActionType.ENCHANT_LIFE_STEAL:
                    action = new EnchantLifeStealAction();
                    break;
                ...
                case eActionType.RATIO_DAMAGE:
                    action = new RatioDamageAction();
                    break;

                case eActionType.REGENERATION:
