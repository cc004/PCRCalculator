...
namespace PCRCaculator.Battle
{
    ...
    public class Skill
    {
        ...
        private bool isLifeStealEnabled = true;
        [JsonIgnore]
        ...
        [JsonIgnore]
        public List<BasePartsData> DamagedPartsList { get => damageedPartsList; set => damageedPartsList = value; }
        [JsonIgnore]
        ...
        [JsonIgnore]
        public List<ActionParameter> ActionParameters { get => actionParmeters; set => actionParmeters = value; }
        [JsonIgnore]
        ...
        public void ReadySkill()
        {
            ...
            {
                foreach (NormalSkillEffect skillEffect in SkillEffects)
                {
                    if (skillEffect.AlreadyFireArmExecedKeys != null && skillEffect.AlreadyFireArmExecedKeys.Count > 0)
                    {
                        foreach (var a in skillEffect.AlreadyFireArmExecedKeys)
                        {
                            skillEffect.AlreadyFireArmExecedData[a] = false;
                        }
                    }
                }
            }
    ...
    public class UnitActionController4Json
    {
        ...
        public class MySkill
        {
            ...
            public List<ActionParameterOnPrefab> GetActionParameterOnPrefab()
            {
                ...
                foreach(My<MyActionParameterOnPrefab> b in ActionParametersOnPrefab)
                {
                    a.Add(b.data.CopyThis());
                }
                return a;
            ...
            {
                List<NormalSkillEffect> a = new List<NormalSkillEffect>();
                foreach(My<MyNormalSkillEffect> b in SkillEffects)
                {
                    a.Add(b.data.)
                }
            }
        ...
        public class MyNormalSkillEffect
        {
            public FilePathPair Prefab;
            public FilePathPair PrefabLeft;
            public My<float>[] ExecTime;
            public bool IsReaction;
            public List<MyNormalSkillEffect> FireArmEndEffects;
            public bool TargetActionIsReflexive;
            public int TargetActionIndex;
            public int TargetActionId;
            public ActionParameter TargetAction;
        ...
        public class MyActionParameterOnPrefab
        {
            ...
            public ActionParameterOnPrefab CopyThis()
            {
                ...
                ac.Details = new List<ActionParameterOnPrefabDetail>();
