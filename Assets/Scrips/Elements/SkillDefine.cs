        ...
        public static readonly Dictionary<eActionType, Func<List<float>, List<float>, bool, float>> SkillActionDictionary = new Dictionary<eActionType, Func<List<float>, List<float>, bool, float>>
    {
      ...
      },
      {
        ...
        public static readonly Dictionary<eActionType, Type> SkillActionTypeDictionary = new Dictionary<eActionType, Type>
        {
            ...
            {
                eActionType.ENVIRONMENT,
                typeof(EnvironmentAction)
            }
        };
        public static readonly Dictionary<eActionType, bool> ProtectEnableDic = new Dictionary<eActionType, bool>
        {
          { (eActionType)1, true },
          { (eActionType)2, false },
          { (eActionType)3, true },
          ...
          { (eActionType)12, true },
          { (eActionType)13, true },
          { (eActionType)14, false },
          { (eActionType)15, false },
          { (eActionType)16, true },
          { (eActionType)17, false },
          { (eActionType)18, false },
          { (eActionType)19, false },
          { (eActionType)20, false },
          { (eActionType)21, false },
          { (eActionType)22, false },
          { (eActionType)23, true },
          { (eActionType)24, false },
          { (eActionType)25, false },
          { (eActionType)26, false },
          { (eActionType)27, false },
          { (eActionType)28, true },
          { (eActionType)29, false },
          { (eActionType)30, false },
          { (eActionType)31, false },
          { (eActionType)32, false },
          { (eActionType)33, true },
          { (eActionType)34, true },
          { (eActionType)35, true },
          { (eActionType)36, false },
          { (eActionType)37, false },
          { (eActionType)38, false },
          { (eActionType)39, false },
          { (eActionType)41, false },
          { (eActionType)42, false },
          { (eActionType)43, false },
          { (eActionType)44, false },
          { (eActionType)45, false },
          { (eActionType)46, true },
          { (eActionType)47, true },
          { (eActionType)48, false },
          { (eActionType)49, true },
          { (eActionType)50, false },
          { (eActionType)51, false },
          { (eActionType)53, false },
          { (eActionType)54, false },
          { (eActionType)56, true },
          { (eActionType)57, true },
          { (eActionType)55, false },
          { (eActionType)58, false },
          { (eActionType)59, false },
          { (eActionType)52, false },
          { (eActionType)60, true },
          { (eActionType)90, false },
          { (eActionType)61, true },
          { (eActionType)62, true },
          { (eActionType)69, true },
          { (eActionType)70, true },
          { (eActionType)63, false },
          { (eActionType)71, false },
          { (eActionType)72, false },
          { (eActionType)73, false },
          { (eActionType)74, false },
          { (eActionType)75, false },
          { (eActionType)92, false },
          { (eActionType)93, false },
          { (eActionType)76, false },
          { (eActionType)80, false },
          { (eActionType)77, false },
          { (eActionType)78, false },
          { (eActionType)79, true },
          { (eActionType)81, false },
          { (eActionType)82, false },
          { (eActionType)83, false },
          { (eActionType)94, false },
          { (eActionType)95, false },
          { (eActionType)902, false },
          { (eActionType)901, false },
          { (eActionType)96, false },
          { (eActionType)97, false },
          { (eActionType)98, false },
          { (eActionType)99, false },
          { (eActionType)100, false },
          { (eActionType)101, true },
          { (eActionType)102, true },
          { (eActionType)103, false },
          { (eActionType)104, false },
          { (eActionType)105, false },
          { (eActionType)106, false },
          { (eActionType)107, false },
          { (eActionType)108, false },
        };
