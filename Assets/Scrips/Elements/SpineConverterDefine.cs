...
namespace Elements
{
  ...
  {
    // Elements.SpineConverterDefine
// Token: 0x060091CD RID: 37325 RVA: 0x001DDDF0 File Offset: 0x004DDDF0
// Note: this type is marked as 'beforefieldinit'.
static SpineConverterDefine()
{
	SpineConverterDefine.DataDic = new Dictionary<eSpineCharacterAnimeId, SpineConverterDefine.ConverterData>
	{
		{
		...
		{
			eSpineCharacterAnimeId.NO_WEAPON_RUN_SUPER,
			new SpineConverterDefine.ConverterData("noWeapon_run_super", eSpineConvertCategoryType.NORMAL, new SpineConverterDefine.CONVERT_FUNC(SpineConverterDefine.NO_WEAPON_CONVERT_FUNC))
		},
		{
		...
		{
			eSpineCharacterAnimeId.BLB_DRAMA,
			new SpineConverterDefine.ConverterData("blb_", eSpineConvertCategoryType.BLB_DRAMA, new SpineConverterDefine.CONVERT_FUNC(SpineConverterDefine.BLB_CONVERT_FUNC))
		},
		{
		...
		{
			eSpineCharacterAnimeId.DUNGEON_IDLE_SKIP,
			new SpineConverterDefine.ConverterData("idle", eSpineConvertCategoryType.NORMAL, new SpineConverterDefine.CONVERT_FUNC(SpineConverterDefine.DEFAULT_CONVERT_FUNC))
		},
		{
		...
		{
			eSpineCharacterAnimeId.LOSE,
			new SpineConverterDefine.ConverterData("lose", eSpineConvertCategoryType.NORMAL, new SpineConverterDefine.CONVERT_FUNC(SpineConverterDefine.COMMON_CONVERT_FUNC))
		},
		{
		...
		{
			eSpineCharacterAnimeId.RACE_ENEMY,
			new SpineConverterDefine.ConverterData("anniversary_race", eSpineConvertCategoryType.RACE_ENEMY, new SpineConverterDefine.CONVERT_FUNC(SpineConverterDefine.RACE_CONVERT_FUNC))
		},
		{
		...
		{
			eSpineCharacterAnimeId.SUB_UNION_BURST,
			new SpineConverterDefine.ConverterData("skillUb", eSpineConvertCategoryType.NORMAL, new SpineConverterDefine.CONVERT_FUNC(SpineConverterDefine.BATTLE_CONVERT_FUNC))
		},
		{
		...
		{
			eSpineCharacterAnimeId.SUMMON_SKILL_EFFECT_REVERSE,
			new SpineConverterDefine.ConverterData("effect_reverse", eSpineConvertCategoryType.NORMAL, new SpineConverterDefine.CONVERT_FUNC(SpineConverterDefine.DEFAULT_CONVERT_FUNC))
		},
		{
...
private static void BLB_CONVERT_FUNC(out eSpineBinaryAnimationId _binaryId, out int _id, int _atlasFileUnitId, string _checkStr, string _animeName, Func<int, bool> _isUniqueMotion)
{
	SpineConverterDefine.DEFAULT_CONVERT_FUNC(out _binaryId, out _id, 0, "", "", null);
	if (!_checkStr.Contains(_animeName))
	{
		return;
	}
	_binaryId = eSpineBinaryAnimationId.BLB_DRAMA;
	_id = 0;
}

public const int NYXMK2_UNITID = 192101;

    public static Dictionary<eSpineCharacterAnimeId, ConverterData> DataDic { get; set; }
