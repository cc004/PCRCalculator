...
namespace Elements
{
  public class IfHasTargetAction : ActionParameter
  {
      ...
      Dictionary<eValueNumber, FloatWithEx> _valueDictinary)
    {
      ...
      if (_skill.ActionParameters.Find(e => e.ActionId == ActionDetail2).TargetList.Count == 0)
      {
        cancelAction(_skill.ActionParameters.Find(e => e.ActionId == ActionDetail1), _skill);
