...
namespace Elements
{
  public class CureAction : ActionParameter
  {
      ...
      Dictionary<eValueNumber, FloatWithEx> _valueDictionary)
    {
      ...
      _target.Owner.CureAbnormalState((CureAction.eCureActionType) this.ActionDetail1);
    }
