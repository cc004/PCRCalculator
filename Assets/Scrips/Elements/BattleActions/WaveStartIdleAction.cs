...
namespace Elements
{
  public class WaveStartIdleAction : ActionParameter
  {
    ...
    {
      if ((_source.IsOther ? battleManager.EnemyList : battleManager.UnitList).FindAll(e => e != _source && (long) e.Hp > 0L).Count == 0)
      {
      ...
      else
      {
        ...
        _sourceActionController.AppendCoroutine(updateIdle(_source), ePauseType.SYSTEM, _source);
      }
    }
...
label_4:
      ...
      Dictionary<eValueNumber, FloatWithEx> _valueDictionary)
    {
      ...
      if (currentSpineCtrl.CurColor.a != 0.0)
        return;
